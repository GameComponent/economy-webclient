  ...
  <div>
    ...
    <div class="p-16">
      ...
      <div class="mt-8 border" v-if="itemAmounts.length > 0 || currencyAmounts.length > 0">
        ...
        <table class="gc-table mt-4">
          ...
          <tbody>
            <tr v-for="currencyAmount in currencyAmounts" :key="currencyAmount.id">
              ...
              <td>
                <button @click="onClickRemoveCurrency(currencyAmount.id)" class="gc-button">
                  Remove
                </button>
              </td>
            </tr>
            ...
            <tr v-for="itemAmount in itemAmounts" :key="itemAmount.id">
              ...
              <td>
                <button @click="onClickRemoveItem(itemAmount.id)" class="gc-button">
                  Remove
                </button>
              </td>
            </tr>
        ...
        <div class="mt-8">
          <button class="gc-button" @click="onClickCreatePrice">
            Create price
          </button>
        </div>
      </div>
